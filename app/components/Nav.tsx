...
const Nav: React.FC<NavProps> = ({ className = '' }) => {
  ...
  return (
    <div
      className={`fixed bottom-0 left-0 right-0 w-[430px] mx-auto h-[122px] bg-white shadow-[0px_-8px_16px_0px_rgba(34,34,34,0.10)] z-50 ${className}`}
    >
      <div className="flex justify-around items-center h-full pb-[45px]">
        <button
